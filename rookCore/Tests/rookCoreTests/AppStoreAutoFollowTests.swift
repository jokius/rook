...
struct AppStoreAutoFollowTests {
    ...
    @Test func autoFollowFirePostsFollowedNotification() {
        ...
        let token = NotificationCenter.default.addObserver(forName: .rookAutoFollowed, object: nil,
                                                           queue: nil) { note in
...
/// A Sendable reference box so the `queue: nil` `.rookAutoFollowed` observer (a `@Sendable` block) can
