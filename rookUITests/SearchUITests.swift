...
final class SearchUITests: XCTestCase {
    ...
    func testSearchBarOpensTypesAndCounts() throws {
        ...
        // contain "rookFINDME", guaranteeing at least two matches in the scrollback.
        app.typeText("echo rookFINDME rookFINDME")
        ...
        let label = waitForMatchLabel(field: field, needle: "rookFINDME", timeout: 12)
