...
struct CommandsTests {
    ...
    @Test func workspaceMoveRequiresToFails() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["workspace", "move"]) }
    }
    ...
    @Test func workspaceColorRejectsMalformedHex() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["workspace", "color", "orange"]) }
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["workspace", "color", "#ff88"]) }
    }
    ...
    @Test func workspaceIconRejectsUnsupportedImage() {
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["workspace", "icon", "/icons/logo.gif"]) }
    }
    ...
    @Test func sessionFileTreeRerootRequiresPath() {
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "filetree", "reroot"]) }
    }
    ...
    @Test func sessionGoRequiresToFails() {
        // --to has no default, so omitting it must fail to parse (the direction is validated server-side).
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "go"]) }
    }
    ...
    @Test func sessionOverlayOpenRejectsBadBackgroundColor() {
        ...
        #expect(throws: (any Error).self) {
            try Rookctl.parseAsRoot(["session", "overlay", "open", "cmd", "--background-color", "purple"])
        }
    }
    ...
    @Test func sessionOverlayResizeRejectsBadArgs() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "overlay", "resize"]) }
        #expect(throws: (any Error).self) {
            try Rookctl.parseAsRoot(["session", "overlay", "resize", "--full", "--size-percent", "50"])
        }
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "overlay", "resize", "--size-percent", "150"]) }
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "overlay", "resize", "--size-percent", "0"]) }
    }
    ...
    @Test func sessionOverlayBlockRejectsWait() {
        ...
        #expect(throws: (any Error).self) {
            try Rookctl.parseAsRoot(["session", "overlay", "open", "cmd", "--block", "--wait"])
        }
    }
    ...
    @Test func sidebarModeRejectsBadMode() {
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["sidebar", "mode", "sideways"]) }
    }
    ...
    @Test func sessionFlagRejectsBadMode() {
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["session", "flag", "bogus"]) }
    }
    ...
    @Test func keymapReloadRejectsWindowSelector() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["keymap", "reload", "--window", "w1"]) }
    }
    ...
    @Test func keymapListRejectsWindowSelector() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["keymap", "list", "--window", "w1"]) }
    }
    ...
    @Test func configReloadRejectsWindowSelector() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["config", "reload", "--window", "w1"]) }
    }
    ...
    @Test func themeSetSyncWithBothSides() throws {
        #expect(try request(["theme", "set", "--light", "Builtin Light", "--dark", "rook"])
            == ControlRequest(cmd: .themeSet, args: ControlArgs(light: "Builtin Light", dark: "rook")))
    }
    ...
    @Test func themeSetRejectsNamePlusLight() {
        ...
        #expect(throws: (any Error).self) {
            try Rookctl.parseAsRoot(["theme", "set", "Dracula", "--light", "Builtin Light"])
        }
    }
    ...
    @Test func themeRejectsWindowSelector() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["theme", "set", "Nord", "--window", "w1"]) }
    }
    ...
    @Test func windowRenameRequiresBothArgsFails() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["window", "rename", "9f3c"]) }
    }
    ...
    @Test func windowCommandsRejectWindowSelector() {
        ...
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["window", "list", "--window", "w1"]) }
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["window", "select", "9f3c", "--window", "w1"]) }
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["quick", "--window", "w1"]) }
    }
    ...
    @Test func windowCommandsKeepSocketAndJSON() throws {
        ...
        let parsed = try Rookctl.parseAsRoot(["window", "list", "--socket", "/tmp/x.sock", "--json"])
    ...
    @Test func invalidSubcommandFailsToParse() {
        #expect(throws: (any Error).self) { try Rookctl.parseAsRoot(["bogus"]) }
    }
    ...
    @Test func sessionTypeWithoutTextOrStdinFails() throws {
        ...
        let parsed = try Rookctl.parseAsRoot(["session", "type"])
    ...
    @Test func socketPathExplicitFlagWins() throws {
        ...
        let env = ["ROOK_STATE_DIR": "/tmp/state", "HOME": "/Users/x"]
    ...
    @Test func socketPathStateDirOverHome() throws {
        ...
        let env = ["ROOK_STATE_DIR": "/tmp/state", "HOME": "/Users/x"]
        #expect(command.options.socketPath(env: env) == "/tmp/state/rook.sock")
    }

    @Test func socketPathFallsBackToHome() throws {
        let command = try Tree.parse([])
        let env = ["HOME": "/Users/x"]
        #expect(command.options.socketPath(env: env) == "/Users/x/Library/Application Support/rook/rook.sock")
    }

    @Test func socketPathFallsBackToTmpWithoutHome() throws {
        let command = try Tree.parse([])
        #expect(command.options.socketPath(env: [:]) == "/tmp/rook/rook.sock")
    }
