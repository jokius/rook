...
final class MockControlActions: ControlActions {
    enum Call: Equatable {
        ...
        case sessionTypeBatch(targets: [String], flagged: Bool, window: String?, ControlSessionTypeOptions)
    ...
    var nextSessionTypeBatchResponse = ControlResponse(ok: true, result: ControlResult(affected: 0))
