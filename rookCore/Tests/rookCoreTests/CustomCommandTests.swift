...
struct CustomCommandTests {
    ...
    @Test func referencesSessionScopedContextDetectsSessionTokensButNotLaunchers() {
        ...
        #expect(!CommandContext.referencesSessionScopedContext(#"rookctl session new --command "ssh work""#))
        #expect(!CommandContext.referencesSessionScopedContext("rookctl --socket {AGT_SOCKET} session new"))
