...
final class ControlAPIThemeUITests: ControlAPITestCase {
    func testThemeSyncWithSystemAppearance() throws {
        ...
        let bad = try sendCommand(#"{"cmd":"theme.set","args":{"light":"NotARealTheme","dark":"rook"}}"#)
        ...
        // (the fresh-install rook default).
        ...
        XCTAssertEqual(darkResult["light"] as? String, "rook", "the light side seeds from the current theme")
