...
struct ControlResolveTests {
    ...
    @Test func socketPathWithStateDir() {
        let path = ControlResolve.socketPath(stateDir: "/tmp/rook-state", appSupport: "/Users/x/Library/Application Support/rook")
        #expect(path == "/tmp/rook-state/rook.sock")
    }

    @Test func socketPathWithoutStateDirUsesAppSupport() {
        let path = ControlResolve.socketPath(stateDir: nil, appSupport: "/Users/x/Library/Application Support/rook")
        #expect(path == "/Users/x/Library/Application Support/rook/rook.sock")
    }
}
