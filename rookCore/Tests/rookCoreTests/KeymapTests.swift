...
struct KeymapTests {
    ...
    @Test func parseArrowChordMapLines() {
        // arrows are part of the chord grammar, so these parse cleanly.
        let text = """
    ...
    @Test func keymapStoreLoadsFileAndRecoversWhenMissing() throws {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("rook-keymap-\(UUID().uuidString)")
