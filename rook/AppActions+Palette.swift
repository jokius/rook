...
extension AppActions {
    ...
    private func paletteItem(for session: Session, in store: AppStore,
                             status: AgentStatus? = nil, statusColor: String? = nil,
                             statusShape: StatusShape? = nil) -> PaletteItem {
        let id = session.id
    ...
    func paletteThemes() -> [PaletteItem] {
        ...
        // bundled "rook" theme, which appears in the named list like any other. While following the
