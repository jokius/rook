...
/// and the seam posts `.rookSystemAppearanceChanged` directly, so the REAL flip path (scheme sync →
...
final class AppearanceFlipUITests: ControlAPITestCase {
    func testAppearanceFlipPreservesFontZoom() throws {
        ...
        // app — which drives the debounced flip reload (the seam posts .rookSystemAppearanceChanged,
