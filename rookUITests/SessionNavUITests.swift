...
/// rookCore unit tests). Sessions are Metal `GhosttySurfaceView`s with no readable accessibility
...
final class SessionNavUITests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        markerDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("rook-sessionnav-\(UUID().uuidString)", isDirectory: true)
