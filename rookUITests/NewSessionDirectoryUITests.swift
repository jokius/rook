...
extension ControlAPIUITests {
    ...
    private func armCurrentSessionMode() throws -> (seededID: String, marker: URL, markerName: String) {
        let marker = FileManager.default.temporaryDirectory
            .appendingPathComponent("rook-newsess-\(UUID().uuidString.prefix(8))", isDirectory: true)
    ...
    /// Settings is left OPEN on purpose: ⌘W is Close Session in rook (it would kill the seeded
