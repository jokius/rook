...
struct WindowControlArea: NSViewRepresentable {
    ...
    final class TitlebarControlView: NSView {
        ...
        ///
        /// A UITest env override (`ROOK_UITEST_DOUBLECLICK_ACTION`) takes precedence so the gesture
        ...
        private func performTitlebarDoubleClickAction() {
            ...
            let action = ProcessInfo.processInfo.environment["ROOK_UITEST_DOUBLECLICK_ACTION"]
