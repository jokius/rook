...
/// `ControlServer` window-command action arms — create, list, select, close, resize, move, zoom, minimize,
/// rename, and delete on-screen windows via `WindowRegistry` + the `WindowLibrary`. Split out of
