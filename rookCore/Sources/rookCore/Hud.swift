...
public enum HudSpinner: String, Codable, CaseIterable, Sendable {
    ...
    /// The same accepted set comma-joined — the prose form for `rookctl --spinner-style` help and its
...
public enum HudPosition: String, Codable, CaseIterable, Sendable {
    ...
    /// The accepted names comma-joined — the prose form for `rookctl --position` help.
...
public enum HudLayout {
    ...
    public static let fileEnvKey = "ROOK_HUD_FILE"
