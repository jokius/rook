...
/// `ControlDispatcher+Hud`; this layer supplies the three things rookCore cannot resolve — the bundled
...
extension ControlServer {
    ...
    static func bodyFile(for sessionID: UUID) -> String {
        (NSTemporaryDirectory() as NSString).appendingPathComponent("rook-hud-\(sessionID.uuidString).txt")
    }
